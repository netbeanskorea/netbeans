 ...
 * <li>단위업무명: [PU]권한-사용자그룹 맵핑</li>
 * <li>설  명 : </li>
 * <li>작성일 : 2013-10-04 16:18:45</li>
 * <li>작성자 : 강훈기 (hunkee)</li>
 * </ul>
 *
 * @author 강훈기 (hunkee)
 */
public class PAUT300 extends ams.fwk.base.ProcessUnit  {
	 ...
	 */
	public IDataSet pAUT30001(IDataSet requestData, IOnlineContext onlineCtx){
	    ...
	    try {
	    	IDataSet ds = callSharedBizComponentByDirect(sc, "selectRoleGroupMappingList", requestData, onlineCtx);
			...
			responseData.putRecordSet(rs);
		  	...
		  	throw e;
		    	...
		    	throw new BizRuntimeException("M1000000", new String[]{"권한-사용자그룹 목록조회"}, e);
	    }
	 ...
	 * @return 처리결과 DataSet 객체
	 */
	public IDataSet pAUT30002(IDataSet requestData, IOnlineContext onlineCtx){
		SharedBizComponent sc = lookupSharedBizComponent("abm.AUTSBase");
		Log log = getLog(onlineCtx);
	    IDataSet responseData = new DataSet();
	    ...
	    try {
	    	...
	    	IDataSet ds = callSharedBizComponentByDirect(sc, "selectGroupListByRole", requestData, onlineCtx);
	    	...
	    	responseData.putRecordSet(rs);
		  	...
		  	throw e;
		    	...
		    	throw new BizRuntimeException("M1000000", new String[]{"맵핑된 권한제외 사용자그룹 목록조회"}, e);
	    }
	    // 처리 결과값을 responseData에 넣어서 리턴하십시오
	    responseData.setOkResultMessage("M3000000", null);
	    return responseData;
