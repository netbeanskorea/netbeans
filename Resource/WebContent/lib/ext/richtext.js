...
function writeRichText(rte, html, width, height, buttons, readOnly) {
	...
	//		document.writeln('		<td><img class="rteImage" src="' + imagesPath + 'redo.gif" width="25" height="24" alt="Redo" title="Redo" onClick="rteCommand(\'' + rte + '\', \'redo\')"></td>');
		...
		document.writeln('<iframe id="' + rte + '" name="' + rte + '" width="' + width + 'px" height="' + height + 'px" src="' + 'blank.htm"></iframe>');
		...
		if (!readOnly) {
			document.writeln('<textarea class="textarea04" name="' + rte + '" id="' + rte + '" style="width: ' + width + 'px; height: ' + height + 'px;">' + html + '</textarea>');
		} else {
			document.writeln('<textarea class="textarea04" name="' + rte + '" id="' + rte + '" style="width: ' + width + 'px; height: ' + height + 'px;" readonly>' + html + '</textarea>');
		}
	}
}
...
function dlgInsertTable(rte, command) {
	...
	window.open('insert_table.htm', 'InsertTable', windowOptions);
}
