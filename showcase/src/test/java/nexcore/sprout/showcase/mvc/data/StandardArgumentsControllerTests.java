...
import nexcore.sprout.showcase.mvc.data.standard.StandardArgumentsController;
...
public class StandardArgumentsControllerTests {
	...
	public void request() throws Exception {
		this.mockMvc.perform(get("/data/standard/request"))
				//.andExpect(content().string(startsWith("request = org.springframework.mock.web.MockHttpServletRequest@")));
				.andExpect(content().string(startsWith("request = org.springframework.test.web.servlet.request.Servlet3MockHttpServletRequest@")));	
	}
