...
<!-- comment 영역  -->
<h3>  @Controller,@RequestMapping,@ResponseBody  어노테이션을 이용한 기본적인 문자열요청 방법 입니다.</h3>
<!-- comment 영역  -->

<!-- Tip 영역  -->
<p>스크립트에서 사용하는 MvcUtil은 별동의 공통으로 정의해야 합니다.
</p>
<!-- Tip 영역  -->
...
<div id="tabs">
	 <ul>
		...
		<li><a href="<c:url value="/form.frag" />" title="forms">Forms</a></li>
		<li><a href="<c:url value="/fileupload.frag" />" title="fileupload">File Upload</a></li>
