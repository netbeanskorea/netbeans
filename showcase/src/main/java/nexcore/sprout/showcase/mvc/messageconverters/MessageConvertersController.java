package nexcore.sprout.showcase.mvc.messageconverters;
...
public class MessageConvertersController {
	...
	public @ResponseBody Channel writeChannel(HttpServletRequest request) {
		Channel channel = new Channel();
		channel.setFeedType("rss_2.0");
		channel.setTitle("My RSS feed");
		channel.setDescription("Description");
		channel.setLink(request.getContextPath()+"/rss");
		return channel;
	}
